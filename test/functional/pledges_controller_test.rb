...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { amount: @pledge.amount, pledgetype_id: @pledge.pledgetype_id, userdata_id: @pledge.userdata_id }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { amount: @pledge.amount, pledgetype_id: @pledge.pledgetype_id, userdata_id: @pledge.userdata_id }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
